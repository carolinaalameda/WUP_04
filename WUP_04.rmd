...
According to the model 1, the P value is significantly small. The P value represents the chances of getting this result of something further when the null hypothesis is actually very true. Therefore I reject the null hypothesis.
...
This chart shows how the high school and graduate school are different from each other as well as LT high school and graduate school are also different from each other.
